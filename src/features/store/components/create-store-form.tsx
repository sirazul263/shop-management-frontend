...
export const CreateStoreForm = ({ onCancel }: CreateStoreFormPros) => {
  ...
  return (
    <Card className="w-full h-full  border-none shadow-none">
      <CardHeader className="flex pb-3 pt-0 px-7">
        <CardTitle className="text-xl font-bold">Create a new store</CardTitle>
      </CardHeader>
      <div className="px-7 ">
        <DottedSeparator />
      </div>
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-x-5">
                      ...
                      <div className="flex flex-col ">
                        <p className="text-sm">Store Icon</p>
